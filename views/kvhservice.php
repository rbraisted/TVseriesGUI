...
<table height="600px" border="1">
    ...
    <tr>
        <td width="250" valign="top">
            ...
            <input type="button" id="button0" value="get_message_protocol_version" onclick="SendGetCommand('get_message_protocol_version')" style="width:250px" />
            <input type="button" id="button1" value="get_product_registration" onclick="SendGetCommand('get_product_registration')" style="width:250px" />
            <input type="button" id="button2" value="get_vessel_config" onclick="SendGetCommand('get_vessel_config')" style="width:250px" />
            <input type="button" id="button3" value="get_lnb_list" onclick="SendGetCommand('get_lnb_list')" style="width:250px" />
            <input type="button" id="button4" value="get_satellite_service" onclick="SendGetCommand('get_satellite_service')" style="width:250px" />
            <input type="button" id="button5" value="get_checkswitch_mode" onclick="SendGetCommand('get_checkswitch_mode')" style="width:250px" />
            <input type="button" id="button6" value="antenna_status" onclick="SendGetCommand('antenna_status')" style="width:250px" />
            <input type="button" id="button7" value="antenna_versions" onclick="SendGetCommand('antenna_versions')" style="width:250px" />
            <input type="button" id="button8" value="get_antenna_config" onclick="SendGetCommand('get_antenna_config')" style="width:250px" />
            <input type="button" id="button9" value="get_satellite_list" onclick="SendGetCommand('get_satellite_list')" style="width:250px" />
            <input type="button" id="button10" value="get_satellite_params_header" onclick="SendGetCommand('get_satellite_params_header')" style="width:250px" />
            <input type="button" id="button11" value="get_satellite_groups" onclick="SendGetCommand('get_satellite_groups')" style="width:250px" />
            <input type="button" id="button12" value="get_autoswitch_status" onclick="SendGetCommand('get_autoswitch_status')" style="width:250px" />
            <input type="button" id="button13" value="get_autoswitch_configured_names" onclick="SendGetCommand('get_autoswitch_configured_names')" style="width:250px" />
            <input type="button" id="button14" value="get_multiswitch_mode" onclick="SendGetCommand('get_multiswitch_mode')" style="width:250px" />
        ...
        <td style="width:325px" valign="top" align="center">
            ...
            <select id="chooseSetting" style="font-family:monospace,courier,courier new">
                ...
                <option value="set_multiswitch_mode">set_multiswitch_mode</option>
            ...
            <table>
                ...
                <tr id="field_NmeaHeadSource" class="hideField">
                    <td id="fdNmeaHeadSource" align="left" style="width:100px">&nbsp;</td>
                    <td align="left" style="width:225px">
                        <select id="fdinNmeaHeadSource" style="width:175px;text-align:left;font-family:monospace,courier,courier new">
                            <option value="">--- Choose One ---</option>
                            <?php if(isset($nmeaHeadSources)) echo $nmeaHeadSources ?>
                        </select>
                    </td>
                </tr>
                <tr id="field_NmeaGpsSource" class="hideField">
                    <td id="fdNmeaGpsSource" align="left" style="width:100px">&nbsp;</td>
                    <td align="left" style="width:225px">
                        <select id="fdinNmeaGpsSource" style="width:175px;text-align:left;font-family:monospace,courier,courier new">
                            <option value="">--- Choose One ---</option>
                            <?php if(isset($nmeaGpsSources)) echo $nmeaGpsSources ?>
                        </select>
                    </td>
                </tr>
                <tr id="field_Lnb" class="hideField">
                    ...
                    <td align="left" style="width:225px">
                        <select id="fdinLnb" style="width:175px;text-align:left;font-family:monospace,courier,courier new">
                            <option value="">--- Choose One ---</option>
                            <?php if(isset($lnbList)) echo $lnbList ?>
                        </select>
                    </td>
                </tr>
                <tr>
