...
<div class="wiz-view">
	<div class="wiz-content">
		...
		<div class="tac i dfs13 mfs13 dlh1.6 mlh1.6 mt3 mb3 instructions"><br></div>
	...
	<div class="bottom-bar">
		<a href="/wizard/13.php" class="btn prev-btn prev-icon fl">Previous</a>
		<a href="/wizard/15.php" class="btn next-btn next-icon fr">Next</a>
	</div>
 </div>
