...
<table height="600px" border="1">
    ...
    <tr>
        <td width="200" valign="top">
            ...
            <input type="button" id="button25" value="get_details" onclick="get_details()" style="width:200px" />
            <input type="button" id="button27" value="file_transfer" onclick="window.open('../kvhservicefiletransfer.php')" style="width:200px" />
            <input type="button" id="button28" value="telnet_connect" onclick="window.open('../kvhserviceCL.php')" style="width:200px" />
        </td>
